...
<div>
    <table class="table">
        <thead>
            ...
            <th scope="col">% Populacao por Cidade</th><!-- aqui é calculado "porcentagem de população da cidade por estado" calculando população por cidade dividido por população por estado vezes 100 -->
