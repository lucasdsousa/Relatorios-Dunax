<x-guest-layout>
    <form method="POST" action="{{ route('cadastrar') }}">
        ...
        <!-- Name -->
        <div>
            <x-input-label class="text-white" for="name" :value="__('Nome')"/>
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label class="text-white" for="password" :value="__('Senha')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label class="text-white" for="password_confirmation" :value="__('Confirme a Senha')" />
