...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Dulub Área Interna</title>
    ...
    <body class="font-sans text-gray-900 antialiased flex-1">
        ...
        <div class="flex flex-col items-center justify-center min-h-screen" style="background-color: #4B5563;">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg" style="background-color: rgba(75, 85, 99, 0.7);">
                {{ $slot }}
            </div>
        </div>
    </body>
